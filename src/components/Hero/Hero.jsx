  ...
  return (
    <div class="  hero bg-black bg-fixed bg-center  bg-cover bg-no-repeat w-full min-h-[95vh] ">
      <div className="flex flex-col justify-start items-center bg-gradient-to-b from-black  gap-16 min-h-[95vh] ">
        <h2 className="hidden md:inline-block md:text-8xl uppercase font-extrabold tracking-[15px] lg:tracking-[30px] text-white mt-16  ">
          FRON
          <span className="border-b text-primary border-primary">FITNESS</span>
        </h2>
        <h2 className="md:hidden text-center text-6xl uppercase font-extrabold tracking-[15px] lg:tracking-[30px] text-white my-16">
          FRON <br />
          <span className="border-b  text-primary border-primary">FITNESS</span>
        </h2>
