  ...
  return (
    <>
      <div className=" w-full flex flex-col justify-center items-center">
        <h4 className="text-6xl font-semibold mt-10 mx-4 md:mx-20 text-center tracking-wide ">
          Nuestros{" "}
          <span className="tracking-wide border-b-2 border-primary ">
            Productos
          </span>{" "}
        </h4>
        <p className=" text-xl font-light mx-4 mt-10 md:mx-20 text-center tracking-wider">
          Descubre los mejores suplementos para alcanzar tus metas y Maximizar tu
          potencial.
        </p>
      </div>
      <div className="my-10 h-60  xl:h-78 2xl:h-96">
