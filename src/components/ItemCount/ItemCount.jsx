  ...
  return (
    <>
      <div className="flex items-center">
        ...
        className=" flex justify-center items-center  md:w-64 font-bold  border border-gray-900 text-gray-900 py-2 px-14 md:px-4 hover:bg-black hover:text-white rounded-xl transition-colors mb-6">
          <MdOutlineAddShoppingCart className="text-xl mr-2 font-bold" />
          Agregar al Carrito
        </button>
    </>
  );
